...
public class RestAccess  {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (appName != null && CuratorUtil.nodeExists(CuratorUtil.ZK_HOSTS + "/" + hostName + ":" + appName)) {
                hostsNode = CuratorUtil.getNodeValue( CuratorUtil.ZK_HOSTS, CuratorUtil.ZK_HOSTS + "/" + hostName + ":" + appName, hostName + ":" + appName);
            } else {
                hostsNode = CuratorUtil.getNodeValue( CuratorUtil.ZK_HOSTS, CuratorUtil.ZK_HOSTS + "/" + hostName, hostName);
            }
            ...
            if (clusterName != null && appName == null) {
                if (CuratorUtil.nodeExists(lookupPath + "/" + hostName)) {
                    searchPath.add(lookupPath + "/" + hostName);
                }
                if (CuratorUtil.nodeExists(lookupPath + "/" + clusterName)) {
                    searchPath.add(lookupPath + "/" + clusterName);
                }
                if (CuratorUtil.nodeExists(lookupPath + "/" + clusterName + "/" + hostName)) {
                ...
                if (CuratorUtil.nodeExists(lookupPath + "/" + appName)) {
                    searchPath.add(lookupPath + "/" + appName);
                }
                if (CuratorUtil.nodeExists(lookupPath + "/" + appName + "/" + hostName)) {
                ...
                if (CuratorUtil.nodeExists(lookupPath + "/" + clusterName + "/" + appName)) {
                    searchPath.add(lookupPath + "/" + clusterName + "/" + appName);
                }
                if (CuratorUtil.nodeExists(lookupPath + "/" + clusterName + "/" + appName + "/" + hostName)) {
            ...
            for (String propName : propNames) {
                ...
                for (String path : searchPath) {
                    ...
                    propertyNode = CuratorUtil.getNodeValue( path, path + "/" + propName, propName);
